...
$(".list-group").on("change", "input[type='text']", function() {
  ...
  var index = $(this)
    ...
    // ipdate taskin array and resave to local storage
    ...
    var taskSpan = $("<span>")
      ...
      // pass tasks <li> element into auditTask() to chekc new due date
...
$(".card .list-group").sortable({
  ...
  deactivate: function(event) {
    console.log("deactivate", TouchList);
  },
  over: function(event) {
...
// add calendar to date
$("#modalDueDate").datepicker();
  minDate: 1

// change styling when due date is approaching
var auditTask = function (taskEl) {
  // get date from task eleement
  ...
  $(taskEl).removeClass("list-group-item0warning list-group-item-danger");
